...
_LAZY: dict[str, tuple[str, str]] = {
    ...
    "LivePool":           ("tradetropy.live", "LivePool"),
    "Recorder":           ("tradetropy.live", "Recorder"),
    ...
    # -- Robustness ------------------------------------------------------------
    "MonteCarlo":         ("tradetropy.robustness", "MonteCarlo"),
    "MonteCarloConfig":   ("tradetropy.robustness", "MonteCarloConfig"),
    "MonteCarloResult":   ("tradetropy.robustness", "MonteCarloResult"),
    ...
    "TickVolumeProfile":   ("tradetropy.ta", "TickVolumeProfile"),
