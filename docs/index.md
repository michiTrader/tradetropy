...
Everything above ships in the one open-source package: the backtesting engine,
footprint, the full indicator library, live trading, LiveChart, ReplayEngine,
Monte Carlo robustness, Deep Trades and the rest of the order-flow suite are all
included, no gating.
